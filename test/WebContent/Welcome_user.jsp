...
//      var test3 ='${assignedby}';
    ...
    var test=fres.split(" ");
	var addcontrols="<tr>"
    	addcontrols+="<td>   '"+test[0]+"'  </td>"
    	addcontrols+="<td>   '"+test[1]+"'   </td>"
    	addcontrols+="<td>   '"+test[2]+"' </td>"
...
<!-- 			    <option value=""></option> -->
			...
			<input type="button" value="UPDATE:" onclick="GetSelectedTextValue()" />
...
<div>
	<form action="filedataController">
			<div class="row">
			<div class="column">
			<button type="submit" class="btn btn-primary">View Meeting Notes (if any)</button>
			</div>
			<div class="column">
